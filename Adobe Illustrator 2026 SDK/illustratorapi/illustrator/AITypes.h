...
#define kPluginInterfaceVersion27001    0x27000001  // AI 27.0
#define kPluginInterfaceVersion27011    0x27000011  // AI 27.1
#define kPluginInterfaceVersion27021    0x27000021  // AI 27.2
#define kPluginInterfaceVersion27031    0x27000031  // AI 27.3
#define kPluginInterfaceVersion27041    0x27000041  // AI 27.4
#define kPluginInterfaceVersion27051    0x27000051  // AI 27.5
#define kPluginInterfaceVersion27061    0x27000061  // AI 27.6
#define kPluginInterfaceVersion27071    0x27000071  // AI 27.7
#define kPluginInterfaceVersion27081    0x27000081  // AI 27.8
#define kPluginInterfaceVersion27091    0x27000091  // AI 27.9
#define kPluginInterfaceVersion27101    0x27000101  // AI 27.10
#define kPluginInterfaceVersion28001    0x28000001  // AI 28.0
#define kPluginInterfaceVersion28011    0x28000011  // AI 28.1
#define kPluginInterfaceVersion28021    0x28000021  // AI 28.2
#define kPluginInterfaceVersion28031    0x28000031  // AI 28.3
#define kPluginInterfaceVersion28041    0x28000041  // AI 28.4
#define kPluginInterfaceVersion28051    0x28000051  // AI 28.5
#define kPluginInterfaceVersion28061    0x28000061  // AI 28.6
#define kPluginInterfaceVersion28071    0x28000071  // AI 28.7
#define kPluginInterfaceVersion28081    0x28000081  // AI 28.8
#define kPluginInterfaceVersion29001    0x29000001  // AI 29.0
#define kPluginInterfaceVersion29011    0x29000011  // AI 29.1
#define kPluginInterfaceVersion29021    0x29000021  // AI 29.2
#define kPluginInterfaceVersion29031    0x29000031  // AI 29.3
#define kPluginInterfaceVersion29041    0x29000041  // AI 29.4
#define kPluginInterfaceVersion29051    0x29000051  // AI 29.5
#define kPluginInterfaceVersion29061    0x29000061  // AI 29.6
#define kPluginInterfaceVersion29071    0x29000071  // AI 29.7
#define kPluginInterfaceVersion29081    0x29000081  // AI 29.8
#define kPluginInterfaceVersion29091    0x29000091  // AI 29.9
#define kPluginInterfaceVersion30001    0x30000001  // AI 30.0
#define kPluginInterfaceVersion30011    0x30000011  // AI 30.1
#define kPluginInterfaceVersion30021    0x30000021  // AI 30.2
#define kPluginInterfaceVersion30031    0x30000031  // AI 30.3

#define kPluginInterfaceVersion			kPluginInterfaceVersion30031
...
//APIs decorated with this should be called from Render Thread
#define AI_RENDER_THREAD_API
...
struct AIRGBColor {
	...
	constexpr bool operator==(const AIRGBColor& c) const noexcept
	{
...
#define AI_CONCATENATE_IMPL(s1, s2) s1##s2
#define AI_CONCATENATE(s1, s2) AI_CONCATENATE_IMPL(s1, s2)
#define AI_ANONYMOUS_VARIABLE(str) AI_CONCATENATE(str, __LINE__)

/** Exception class thrown by C++ classes */
class Error : public std::exception
{
public:
	Error (AIErr err, const char* whatMessage = nullptr) : mErr(err), mWhatMessage(whatMessage) {}
	const char* what() const AINOEXCEPT override
	{
		return mWhatMessage ? mWhatMessage : "AI Exception ";
	}
	operator AIErr () const AINOEXCEPT { return mErr; }

protected:
	AIErr mErr;
	const char* mWhatMessage{};
};
...
*/
inline void check_ai_error(AIErr err, const char* const whatMessage = nullptr)
{
	if (err != kNoErr)
		throw ai::Error(err, whatMessage);
}
